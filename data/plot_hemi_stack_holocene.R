...
plotNH <- ggplot()+
  ...
  scale_y_continuous(name = expression("Temperature Anomaly (°C)"), limits = c(-2, 2),
                     breaks = scales::pretty_breaks(n = 10))+
  annotate("text", x = 10500, y = 1.7, label = "30°N ~ 90°N")+
  labs(y = "Anomaly",
       x = "Time (Years BP)",
       colour = 'Legend') +
  ...
  scale_x_reverse(limits = c(12000, 100), breaks = scales::pretty_breaks(n = 10))
plotNH
...
plotTrop <- ggplot()+
  ...
  scale_y_continuous(name = expression("Temperature Anomaly (°C)"), limits = c(-2, 2),
                     breaks = scales::pretty_breaks(n = 10))+
  annotate("text", x = 10500, y = 1.7, label = "30°N ~ 30°S")+
  labs(y = "Anomaly",
       x = "Time (Years BP)",
       colour = 'Legend') +
  #ggtitle("Temperature Anomaly 30°N ~ 90°N") +
...
plotSH <- ggplot()+
  ...
  scale_y_continuous(name = expression("Temperature Anomaly (°C)"), limits = c(-2, 2),
                     breaks = scales::pretty_breaks(n = 10))+
  annotate("text", x = 10500, y = 1.7, label = "30°S ~ 90°S")+
  labs(y = "Anomaly",
       x = "Time (Years BP)",
       colour = 'Legend') +
  #ggtitle("Temperature Anomaly 30°N ~ 90°N") +
...
plotGlobal <- ggplot()+
  ...
  scale_y_continuous(name = expression("Temperature Anomaly (°C)"), limits = c(-2, 2),
                     breaks = scales::pretty_breaks(n = 10))+
  annotate("text", x = 10500, y = 1.7, label = "Global")+
  labs(y = "Anomaly",
       x = "Time (Years BP)",
       colour = 'Legend') +
  #ggtitle("Temperature Anomaly 30°N ~ 90°N") +
